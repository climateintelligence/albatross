...
# Add albatross to sys.path to avoid having to full
# install albatross for autodoc.
# Full install of albatross will burst memory limit on ReadTheDocs.
...
project = "Albatross"
copyright = "2023, Matteo Guillani"
author = "Matteo Guillani"
